    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      >
        ...
        <div className="p-7 sm:p-10 border-b border-slate-800/60 pr-16">
          <div className="text-[11px] font-mono text-amber-400/80 uppercase tracking-wider mb-5">
            {sample.category}
          </div>
          <h2 className="text-[24px] sm:text-[30px] font-bold text-white leading-[1.15] tracking-tight">
            {sample.title}
          </h2>
          ...
          <div>
            ...
            <div className="space-y-2.5">
              {sample.details.framework.map((step, i) => (
                <div key={i} className="p-4 bg-slate-900/40 border border-slate-800/60 rounded-lg text-[13px] text-slate-200 leading-relaxed">
                  {step}
                </div>
              ))}
            </div>
